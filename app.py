...
modelp=tf.keras.models.load_model('/content/models/ai-classifier.hdf5')
st.write(
         """
...
file = st.file_uploader("Please upload image to check whether it is  real or is ai generated", type=["jpg", "jpeg"])
